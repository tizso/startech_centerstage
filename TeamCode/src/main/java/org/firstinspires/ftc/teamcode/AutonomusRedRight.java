...
public class AutonomusRedRight extends LinearOpMode {
    ...
    public void runAutonoumousMode() {
        ...
        switch(identifiedSpikeMarkLocation){
            case LEFT:
                dropPurplePixelPose = new Pose2d(25, 3, Math.toRadians(42));
                midwayPose1 = new Pose2d(14, -13, Math.toRadians(60));
                dropYellowPixelPose = new Pose2d(51, -37, Math.toRadians(78));
                break;
            case MIDDLE:
                dropPurplePixelPose = new Pose2d(28, -6, Math.toRadians(0));
                midwayPose1 = new Pose2d(14, -13, Math.toRadians(45));
                dropYellowPixelPose = new Pose2d(38.5, -37,  Math.toRadians(80));
                break;
            case RIGHT:
                dropPurplePixelPose = new Pose2d(16.5, -17, Math.toRadians(0));
                midwayPose1 = new Pose2d(11, -13, Math.toRadians(45));
                dropYellowPixelPose = new Pose2d(28.5, -37, Math.toRadians(83));
                break;
        }
        ...
        //parking right side
        parkPose1 = new Pose2d(-5, -31, Math.toRadians(90));
